...
import imgSrc from '../medias/displacement.jpg'
...
window.addEventListener("load", () => {
    ...
    function animateTextureCanvas() {
        ...
        simpleCanvasContext.fillStyle = "#333333";
    ...
    image.onload = function () {
        ...
        let com = 0.5
        let com2 = 0.3
        simpleCanvasContext.drawImage(image, 100, 100, wid * com, hei * com)
        simpleCanvasContext.drawImage(image, 400, 400, wid * com2, hei * com2)
    }
 */
    // create our plane
