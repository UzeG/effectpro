<template>
    <div ref="fakeBody" @mousemove="handleMousemove($event)" class="fake-body sp-wrapper">
        <section class="section-container">
            <h1 style="color: rgb(69, 64, 220)">才减升合，便以为不足</h1>
        ...
        <section ref="overlay" class="overlay section-container">
            <h1 style="color: rgb(69, 64, 220)">后有客造之，正遇其饮复茗</h1>
            <span @click="handleClick" ref="btn2" class="hover-btn2 btn2">
                ...
                <img :src="getImg('SpotLight/hu.png')" alt="">
            </span>
        </section>
    </div>
</template>
...
.section-container:nth-child(1) {
    background-image: url(../../assets/imgs/SpotLight/茶04.png);
}
.section-container:nth-child(2) {
    background-image: url(../../assets/imgs/SpotLight/茶05.png);
}
